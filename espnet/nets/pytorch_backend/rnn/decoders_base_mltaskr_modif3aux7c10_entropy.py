    ...
    def forward(self, hs_pad, hlens, ys_pad_char, ys_pad_bpe, strm_idx=0): 
        ...
        if SWITCH_BPE == True:
            ...
            for i in six.moves.range(olength_bpe):
                ...
                context = prior_att_c+c2b_prior_att_c # context = torch.cat([prior_att_c, c2b_prior_att_c],dim=1)
                cstates = h2 + h4 # torch.cat([h2, h4],dim=1)
...
def decoder_base_mltaskr_modification3_aux7c10_entropy_for(
