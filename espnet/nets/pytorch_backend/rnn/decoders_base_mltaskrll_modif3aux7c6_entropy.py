...
class MLSoftmaxDecoder(torch.nn.Module):
    def __init__(self, eprojs, dtype, dlayers, dunits, 
        ...
        print('aux7c6 : 7 aux file + entropy + not local attention')
        print('-----------------------------------------------------------------------------------------------------------------')
        ...
        self.classbpe_enc_W   = torch.nn.Linear(cprojs, 2*self.bpeclass_dunits, bias=False)
...
def decoder_base_mltaskller_modification3_aux7c6_entropy_for(
