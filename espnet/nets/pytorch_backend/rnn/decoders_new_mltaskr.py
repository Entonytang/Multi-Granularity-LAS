...
class MLSoftmaxDecoder(torch.nn.Module):
    def __init__(self, eprojs, dtype, dlayers, dunits, 
            ...
            embsize_char=256, embsize_bpe=256): ## RIGHT(28-28)
        ...
        print('This is just the comparable baseline [BPE & CHAR]. mltask.(decoders_new_mltaskr.py-decoder_new_mltaskr_for)')
        print('Deep Fusion :  v10rd... [h1;sigmoid(FC(h1))*h3].')
        print('[decoders_new_mltaskr.py] This is just information transformation from CHAR to BPE (mtaskrn).')
