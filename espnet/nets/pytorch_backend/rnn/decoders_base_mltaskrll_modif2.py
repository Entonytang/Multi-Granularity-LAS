...
class MLSoftmaxDecoder(torch.nn.Module):
    def __init__(self, eprojs, dtype, dlayers, dunits, 
        ...
        print('[decoders_base_mltaskrll-modification2.py] This is just information transformation from char to BPE (mltaskbaserll-modification2).')
...
def decoder_base_mltaskller_modification2_for(
