...
class MLSoftmaxDecoder(torch.nn.Module):
    ...
    def forward(self, hs_pad, hlens, ys_pad_char, ys_pad_bpe, strm_idx=0): 
        ...
        return [self.loss_char, self.loss_bpe, self.loss_aux+self.loss_aux2], [acc_char, acc_bpe, acc_aux]
...
def decoder_base_mltaskller_modification3_aux6_for(
