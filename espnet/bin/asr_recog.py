...
def get_parser():
    ...
    parser.add_argument('--streaming-offset-margin', type=int, default=1,
                        help='Offset margin')
    # for deciding type : the default setting is BPE
    parser.add_argument('--dec-level', type=str, default='BPE', choices=['CHAR', 'BPE'], help="CHAR or BPE dict is used in decoding.")
    parser.add_argument('--CHOICE_SCORE_TYPES', const="bpeonly", default="bpeonly", type=str, nargs='?',
                        choices=["bpeonly", "bpe1char", "bpe2char"],
                        help='CHOICE_SCORE_TYPES default (bpeonly).')        
